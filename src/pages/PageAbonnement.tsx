                  ...
                  <div className="max-w-2xl mx-auto bg-white p-16 rounded-[4rem] shadow-2xl shadow-blue-900/10 border border-slate-100 animate-in slide-in-from-bottom-10 duration-500">
                      ...
                      <div className="space-y-8">
                          <div className="relative group">
                              <input type="file" id="upload" className="hidden" onChange={envoyerPaiement} />
                              <label htmlFor="upload" className="w-full h-32 bg-slate-50 border-4 border-dashed border-slate-200 rounded-[2rem] flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-all">
                                  <PlusCircle size={32} className="text-[#1E3A8A]" />
                                  <span className="text-xs font-black text-slate-400 uppercase tracking-widest">Choisir un fichier</span>
                              </label>
                          </div>
